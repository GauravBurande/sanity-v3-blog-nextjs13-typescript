  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center py-10">
        <p> Built with <span className="text-[red]">❤</span> by <span className="hover:text-[#0acbcb] underline hover:decoration-white decoration-[#0acbcb] cursor-pointer"><a href="https://twitter.com/gauravvan">@gauravvan</a></span></p>
      </div>
    </>
  )
}
